...
class GlobalState(TypedDict):
    ...
    physical_dataframe_path: Optional[str] # Path to shared physical parquet on disk
    
    # cleaning plan & progress tracking
    cleaning_plan: Optional[List[str]]
    task_list: Optional[List[str]]        # Dynamic list of tasks generated by Planner
    current_task_idx: Optional[int]       # Index of currently executing task in task_list
    retry_count: Optional[int]            # Counter for current task self-correction retries
